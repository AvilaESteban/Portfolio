...
const FormVeterinaria = (props) => {
    return(
        <>
         <h3 className='p-2 text-light display-6 text-center'>complete el formulario para agendar una cita</h3>
         
         <form  onSubmit={props.handleSubmit} ref={props.myForm}className='formulario container w-50 text-center'>
             <label className='w-100  bg-dark text-light my-2 '>nombre de mascota</label>
            <input 
